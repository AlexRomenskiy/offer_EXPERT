...
const faqs = [
  ...
  {
    q: 'Я вже пробував автоворонку і спалив бюджет. Є якісь гарантії?',
    a: 'Три критерії: фіксований термін у договорі, повна власність файлів і кампаній з 1-го дня, 30 днів супроводу. У Преміум пакеті — рекламна гарантія: якщо протягом 7 днів не входимо в цільовий CPL — переробка креативів за мій рахунок.',
  },
  {
