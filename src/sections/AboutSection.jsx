...
const principles = [
  {
    title: 'Презентація > експертиза',
    description: 'Сильні експерти застрягають не на тому, що вміють, а на тому, як це показати.',
  },
  {
    title: 'Система, а не інструменти',
    description: 'Воронка, лендинг, бот, оплати, аналітика — як один потік, а не набір розрізнених сервісів.',
  },
  {
    title: 'Видимий і затребуваний',
    description: 'Експерт виходить на потік — без втоми тримати все на собі.',
  },
];
