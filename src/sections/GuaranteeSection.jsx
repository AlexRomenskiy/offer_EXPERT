...
const guarantees = [
  {
    ...
    title: 'Чіткі терміни',
    description:
      'Старт і фініш — у дату. Зафіксовано в договорі від першого дня.',
  },
  {
    icon: 'solar:key-square-linear',
    title: 'Власність — 100%',
    description:
      'Файли, доступи, скрипти, інтеграції — переходять тобі. Працюєш з ким і коли хочеш.',
  },
  {
    icon: 'solar:hand-money-line-duotone',
    title: '100% твоєї виручки',
    description:
      'Без % з продажів. Не партнерство, не rev-share, не приховані доплати. Усе, що приносить система — твоє.',
  },
  {
    icon: 'solar:shield-check-linear',
    title: '30 днів супроводу',
    description:
      'Після запуску — місяць безкоштовних правок, технічної підтримки і відповідей на питання.',
  },
  {
    icon: 'solar:tag-price-linear',
    title: 'Прозора ціна',
    description:
      'Сума узгоджена на старті. Бюджет передбачуваний — без доплат посеред проєкту.',
  },
];
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="relative max-w-3xl mx-auto mb-12 lg:mb-14 anim-trigger text-center">
          ...
          >
            Що ти отримуєш — крім самої системи продажу.
            <span className="block mt-1">П'ять пунктів, прописаних у договорі.</span>
          </p>
        </div>

        {/* === VARIANT C — Side-by-side hero (image + list) === */}
        <div className="anim-trigger anim-fade-up" style={{ transitionDelay: '0.05s' }}>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[24px] md:rounded-[26px] min-h-[360px] md:min-h-[520px] z-10">
              {/* Atmospheric gradient backdrop (until real image arrives) */}
