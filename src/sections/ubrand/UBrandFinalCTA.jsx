  ...
  return (
    <section className="relative py-20 lg:py-28 px-6 md:px-8 lg:px-12">
      <div className="relative z-10 max-w-[760px] mx-auto text-center anim-trigger">
        ...
        >
          One free 30-minute call with {TANIA_NAME} and me. We’ll map your fastest
          path from expertise to booked clients — and lock your −{UBRAND_DISCOUNT_PCT}%
          if you’re in by {UBRAND_DEADLINE_LABEL}.
        </p>
