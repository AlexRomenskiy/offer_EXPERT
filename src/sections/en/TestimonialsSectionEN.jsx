import { pricingEN } from './PricingSectionEN';
import useOneAtATimeSwipe from '../../hooks/useOneAtATimeSwipe';

const fontStack = "'Manrope', sans-serif";
const monoStack = "'JetBrains Mono', monospace";

// Flatten all EN testimonials from all packages into one ordered pool.
// Order: Foundation (4) → Generator (4, Tania first) → Premium (4) = 12 total.
...
/* ============================================================
   TestimonialCard — same chrome as UA, locale-agnostic
   ============================================================ */
